...
% Beim setzen der Figure Properties wird die Position nicht mehr gesetzt
  ...
  %ax_pos = get(ah(1),'Position')
  %ax_opos = get(ah(1),'OuterPosition')
  %ax_ratio = get(ah(1),'DataAspectRatio')
  %yax_cb1 = ax_opos(2)
  %cb_pos = get(cobh,'Position')
  %set(cobh,'Position',cb_pos);
  %set(cobh,'Position',[xax_dist,cb_pos(2),1-2*xax_dist,cb_pos(4)])
